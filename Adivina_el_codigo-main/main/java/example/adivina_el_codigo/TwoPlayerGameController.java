...
public class TwoPlayerGameController {
    ...
    @FXML
    private Label codeSettingLabel;
    ...
    public void initialize() {
        ...
        gameStatusLabel.setText("Modo de dos jugadores! Jugador 2, establece el código.");
        ...
        submitCodeButton.setVisible(true);
        codeSettingLabel.setVisible(true);
    }
    ...
    private void submitCode() {
        ...
        gameLogic.setCodeToGuess(currentGuess);
        gameStatusLabel.setText("Jugador 1, adivina el código!");
        isCodeSettingPhase = false;
        submitCodeButton.setVisible(false);
        codeSettingLabel.setVisible(false);
        currentPlayer = 1;
    ...
    private void submitGuess() {
        ...
        if (feedback.getCorrectPosition() == 4) {
            gameStatusLabel.setText("Jugador " + currentPlayer + " ha adivinado el código! Felicitaciones!");
        } else if (gameLogic.getAttempts() >= 10) {
            gameStatusLabel.setText("Jugador " + currentPlayer + " ha perdido! No quedan más intentos.");
        }

        if (isTwoPlayerMode) {
            currentPlayer = (currentPlayer == 1) ? 2 : 1;
            gameStatusLabel.setText("Turno del jugador " + currentPlayer);
        }
